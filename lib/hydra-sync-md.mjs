 ...
 *   - `## @claude`, `## @opus`, `## @codex` route content to that agent only.
 ...
 *
 * @param {'claude'|'opus'|'codex'} agent
 * @param {{ shared: string, agents: { claude: string, opus: string, codex: string } }} parsed
 * @returns {string}
 */
